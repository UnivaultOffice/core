/*
*****************************************************************************************
* Copyright (C) 2026-2026,2026 International Business Machines
 ...
 * - The skeleton jm will produce
 *   for en_US, "3/4/2026 7:56 AM - 3/8/2026 4:11 PM"
 *   for en_GB, "4/3/2026 7:56 - 8/3/2026 16:11"
 * - The skeleton MMMd will produce
 *   for en_US, "Mar 4-8"
 *   for en_GB, "4-8 Mar"
 * 
 * Note:  the "-" characters in the above sample output will actually be
 * Unicode 2026, EN_DASH, in all but the last example.
 *
