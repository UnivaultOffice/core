...
namespace OOX
{
	namespace FileTypes
	{
		const FileType App				(L"docProps", L"app.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/extended-properties");

		const FileType Core				(L"docProps", L"core.xml",
												L"application/vnd.openxmlformats-package.core-properties+xml",
												L"http://schemas.openxmlformats.org/package/2026/relationships/metadata/core-properties");
		...
		const FileType CustomProperties	(L"docProps", L"custom.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/custom-properties");
		...
		const FileType Theme			(L"theme", L"theme.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/theme", 
												L"theme", true);
		 
		const FileType ThemeOverride	(L"themeOverride", L"themeOverride.xml",
												L"application/vnd.openxmlformats-officedocument.theme+xml",
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/themeOverride", 
		...
		const FileType DocumentComments		(L"", L"commentsDocument.xml",
												L"application/vnd.openxmlformats-officedocument.wordprocessingml.comments+xml",
												L"http://schemas.univaultoffice.github.io/commentsDocument");
		...
		const FileType CommentsExt		(L"", L"commentsExtended.xml", 
												...
												L"http://schemas.microsoft.com/office/2026/relationships/commentsExtended");

		const FileType DocumentCommentsExt		(L"", L"commentsExtendedDocument.xml",
												L"application/vnd.openxmlformats-officedocument.wordprocessingml.commentsExtended+xml",
												L"http://schemas.univaultoffice.github.io/commentsExtendedDocument");
		...
		const FileType CommentsExtensible		(L"", L"commentsExtensible.xml",
												...
												L"http://schemas.microsoft.com/office/2026/08/relationships/commentsExtensible");

		const FileType DocumentCommentsExtensible (L"", L"commentsExtensibleDocument.xml",
												L"application/vnd.openxmlformats-officedocument.wordprocessingml.commentsExtensible+xml",
												L"http://schemas.univaultoffice.github.io/commentsExtensibleDocument");
		...
		const FileType CommentsIds		(L"", L"commentsIds.xml",
												...
												L"http://schemas.microsoft.com/office/2026/09/relationships/commentsIds");

		const FileType DocumentCommentsIds		(L"", L"commentsIdsDocument.xml",
												L"application/vnd.openxmlformats-officedocument.wordprocessingml.commentsIds+xml",
												L"http://schemas.univaultoffice.github.io/commentsIdsDocument");

		const FileType CommentsUserData		(L"", L"commentsUserData.xml",
												L"application/vnd.openxmlformats-officedocument.wordprocessingml.commentsExtensible+xml",
												L"http://schemas.univaultoffice.github.io/commentsUserData");

		const FileType People			(L"", L"people.xml", 
												L"application/vnd.openxmlformats-officedocument.wordprocessingml.people+xml",
												L"http://schemas.microsoft.com/office/2026/relationships/people");

		const FileType DocumentPeople			(L"", L"peopleDocument.xml",
												L"application/vnd.openxmlformats-officedocument.wordprocessingml.people+xml",
												L"http://schemas.univaultoffice.github.io/peopleDocument");

		const FileType CustomXml		(L"customXml", L"item.xml",
												L"",
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/customXml",
		...
		const FileType Image			(L"media", L"image", 
												L"", 
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/image", L"image", true, true);

		const FileType Audio			(L"media", L"audio", 
												L"", 
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/audio", L"audio", true, true);

		const FileType Video			(L"media", L"video", 
												L"", 
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/video", L"video", true, true);

		const FileType Media			(L"media", L"media", 
												L"", 
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/media", L"media", true, true);
		...
		const FileType DiagramData		(L"diagrams", L"data.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/diagramData", 
		...
		const FileType DiagramQuickStyle(L"diagrams", L"quickStyle.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/diagramQuickStyle",
		...
		const FileType DiagramLayout	(L"diagrams", L"layout.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/diagramLayout",
		...
		const FileType DiagramColors	(L"diagrams", L"colors.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/diagramColors",
		...
		const FileType DiagramDrawing	(L"diagrams", L"drawing.xml",
												...
												L"http://schemas.microsoft.com/office/2026/relationships/diagramDrawing", 
		...
		const FileType ActiveX_bin			(L"", L"activeX.bin",
												...
												L"http://schemas.microsoft.com/office/2026/relationships/activeXControlBinary",
												L"activeX/activeX_bin", true, true);

		const FileType VbaProject			(L"", L"vbaProject.bin",
												L"application/vnd.ms-office.vbaProject",
												L"http://schemas.microsoft.com/office/2026/relationships/vbaProject");

		const FileType VbaData				(L"", L"vbaData.xml",
												L"application/vnd.ms-word.vbaData+xml",
												L"http://schemas.microsoft.com/office/2026/relationships/wordVbaData");

		const FileType JsaProject			(L"", L"jsaProject.bin",
												L"",
												L"http://schemas.univaultoffice.github.io/jsaProject");

		const FileType ImportedExternalContent(L"embeddings", L"",
												L"",
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/aFChunk");

		const FileType MicrosoftOfficeUnknown(L"embeddings", L"",
												L"",
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/package", L"embeddings/package", true, true);
		...
		const FileType MicrosoftOfficeExcel_97_2003_Worksheet(L"embeddings", L"Microsoft_Office_Excel_97-2003_Worksheet.xls",
												L"",
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/oleObject");
		...
		const FileType OleObject			(L"embeddings", L"oleObject.bin",
												L"",
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/oleObject", L"embeddings/oleObject", true, true);
		
		const FileType VmlDrawing			(L"drawings", L"vmlDrawing.vml",
												L"application/vnd.openxmlformats-officedocument.vmlDrawing",
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/vmlDrawing", 
		...
		const FileType ExternalLinkLibrary	(L"", L"", 
												L"", 
												L"http://schemas.microsoft.com/office/2026/relationships/xlExternalLinkPath/xlLibrary");
		
		const FileType ExternalLinkPathMissing(L"", L"", 
												L"", 
												L"http://schemas.microsoft.com/office/2026/relationships/xlExternalLinkPath/xlPathMissing");

		const FileType ExternalLinkPathStartup(L"", L"", 
												L"", 
												L"http://schemas.microsoft.com/office/2026/relationships/xlExternalLinkPath/xlStartup");

		const FileType ExternalLinkPathAlternateStartup(L"", L"", 
												L"", 
												L"http://schemas.microsoft.com/office/2026/relationships/xlExternalLinkPath/xlAlternateStartup");

		const FileType LegacyDiagramText	(L"", L"legacyDiagramText.bin",
												L"",
												L"http://schemas.microsoft.com/office/2026/relationships/legacyDiagramText");
		...
		const FileType GlossaryDocument		(L"glossary", L"document.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/glossaryDocument");
