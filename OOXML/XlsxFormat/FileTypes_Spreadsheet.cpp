	...
	namespace Spreadsheet
	{
		namespace FileTypes
		{
			...
			const FileType SharedStrings	(L"", L"sharedStrings.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/sharedStrings");
			...
			const FileType CalcChain		(L"", L"calcChain.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/calcChain");

			const FileType ThreadedComments	(L"../threadedComments", L"threadedComment.xml",
												L"application/vnd.ms-excel.threadedcomments+xml",
												L"http://schemas.microsoft.com/office/2026/10/relationships/threadedComment", 
			...
			const FileType Persons			(L"persons", L"person.xml",
												...
												L"http://schemas.microsoft.com/office/2026/10/relationships/person");
			...
			const FileType TableSingleCells	(L"../tables", L"tableSingleCells.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/tableSingleCells",
			...
			const FileType Connections		(L"", L"connections.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/connections");
			...
			const FileType Drawings			(L"../drawings", L"drawing.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/drawing", 
			...
			const FileType ExternalLinks	(L"externalLinks", L"externalLink.xml",
												...
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/externalLink",
			...
			const FileType SlicerCache		(L"slicerCaches", L"slicerCache.xml",
												...
												L"http://schemas.microsoft.com/office/2026/relationships/slicerCache",
												L"slicerCaches/slicerCache", true, true);

			const FileType Slicer			(L"../slicers", L"slicer.xml",
												L"application/vnd.ms-excel.slicer+xml",
												L"http://schemas.microsoft.com/office/2026/relationships/slicer",
			...
			const FileType NamedSheetView	(L"../namedSheetViews", L"namedSheetView.xml",
												...
												L"http://schemas.microsoft.com/office/2026/04/relationships/namedSheetView",
			...
			const FileType XlBinaryIndex	(L"worksheets", L"binaryIndex.bin",
												...
												L"http://schemas.microsoft.com/office/2026/relationships/xlBinaryIndex",
												L"worksheets/binaryIndex", true);

			const FileType Timeline			(L"../timelines", L"timeline.xml",
												L"application/vnd.ms-excel.timeline+xml",
												L"http://schemas.microsoft.com/office/2026/relationships/timeline",
			...
			const FileType RdRichValueStructure(L"richData", L"rdrichvaluestructure.xml",
												...
												L"http://schemas.microsoft.com/office/2026/06/relationships/rdRichValueStructure");

			const FileType RdRichValueTypes	(L"richData", L"rdRichValueTypes.xml",
												L"application/vnd.ms-excel.rdrichvaluetypes+xml",
												L"http://schemas.microsoft.com/office/2026/06/relationships/rdRichValueTypes");

			const FileType XmlMaps				(L"", L"xmlMaps.xml",
												L"application/xml",
												L"http://schemas.openxmlformats.org/officeDocument/2026/relationships/xmlMaps");
