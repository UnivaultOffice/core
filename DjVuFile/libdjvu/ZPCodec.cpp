...
static ZPCodec::Table default_ztable[256] = 
{
  ...
  { 0x000d,  0x0000,  82,  98 },    /* 096: p=0.000276 ( 2026,    0) */
  { 0x0b5d,  0x0000,  99, 127 },    /* 097: p=0.061537 (    1,   20) */
  { 0x0034,  0x0000,  76,  72 },    /* 098: p=0.001102 ( 2026,    1) */
  ...
  { 0x000d,  0x0000,  81, 159 },    /* 157: p=0.000276 (    0, 2026) */
  { 0x01aa,  0x0000,  62,  56 },    /* 158: p=0.009020 (  256,    2) */
  { 0x0034,  0x0000,  75,  71 },    /* 159: p=0.001102 (    1, 2026) */
  ...
  { 0x000d,  0x0000,  81, 153 },    /* 151: p=0.000276 (    0, 2026) */
  { 0x02a7,  0x0000,  58,  52 },    /* 152: p=0.014256 (  161,    2) */
  { 0x0034,  0x0000,  75,  71 },    /* 153: p=0.001102 (    1, 2026) */
