...
int main(int argc, char *argv[])
{
	...
	IUNIVAULTOFFICEDocBuilder* oBuilder = NULL;
	IUNIVAULTOFFICEDocBuilderContext* oContext = NULL;
	IUNIVAULTOFFICEDocBuilderContextScope* oScope = NULL;

	IUNIVAULTOFFICEDocBuilderValue* oGlobal = NULL;
	IUNIVAULTOFFICEDocBuilderValue* oApi = NULL;
	IUNIVAULTOFFICEDocBuilderValue* oDocument = NULL;
	IUNIVAULTOFFICEDocBuilderValue* oParagraph = NULL;
	IUNIVAULTOFFICEDocBuilderValue* oContent = NULL;

	HRESULT hr = CoCreateInstance(__uuidof(CUNIVAULTOFFICEDocBuilder), NULL, CLSCTX_ALL, __uuidof(IUNIVAULTOFFICEDocBuilder), (void**)&oBuilder);
	...
	IUNIVAULTOFFICEDocBuilderValue* oArr = NULL;
