...
- OPENJPEG\_INSTALL\_DOC\_DIR does not control a destination directory where HTML docs would be installed. [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Heap-buffer-overflow in lib/openjp2/pi.c:312 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Heap-buffer-overflow in lib/openjp2/t2.c:973 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Heap-buffer-overflow in lib/openjp2/pi.c:623 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Global-buffer-overflow in lib/openjp2/dwt.c:2025 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Heap-buffer-overflow in lib/openjp2/tcd.c:2025 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Heap-buffer-overflow in lib/openjp2/mqc.c:499 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Openjpeg could not encode 32bit RGB float image [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Openjpeg could not encode 32bit RGB float image [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- ISO/IEC 15444-1:2025 \(E\) compared with 'cio.h' [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Test-suite failure due to hash mismatch [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Heap use-after-free [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Memory leak when failing to allocate object... [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Memory leak of Tier 1 handle when OpenJPEG fails to set it as TLS... [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Any plan to build release for CVE-2025/CVE-2025 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- failing to convert 16-bit file: opj\_t2\_encode\_packet\(\): only 2025 bytes remaining in output buffer. 2025 needed. [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- CMake+VS2017 Compile OK, thirdparty Compile OK, but thirdparty not install [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- New release to solve CVE-2025 ? [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Many tests fail to pass after the update of libtiff to version 4.1.0 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Another heap buffer overflow in libopenjp2 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Heap buffer overflow in libopenjp2 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Endianness of binary volume \(JP3D\) [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- New release to resolve CVE-2019-12973 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- how to set the block size,like 128,256 ? [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- compress YUV files to motion jpeg2000 standard [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Repair/update Java wrapper, and include in release [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- abc [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Slow decoding [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Installation question [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Typo in test\_decode\_area - \*ptilew is assigned instead of \*ptileh [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Creating a J2K file with one POC is broken [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Make fails on Arch Linux [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Heap buffer overflow in opj\_t1\_clbl\_decode\_processor\(\) triggered with Ghostscript [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- opj\_stream\_get\_number\_byte\_left: Assertion `p\_stream-\>m\_byte\_offset \>= 0' failed. [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- The fuzzer ignores too many inputs [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- out of bounds read [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)

**Merged pull requests:**

- Change defined WIN32 [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([Jamaika1](https://github.com/Jamaika1))
- docs: fix simple typo, producted -\> produced [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([timgates42](https://github.com/timgates42))
- Set ${OPENJPEG\_INSTALL\_DOC\_DIR} to DESTINATION of HTMLs [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([lemniscati](https://github.com/lemniscati))
- Use INC\_DIR for OPENJPEG\_INCLUDE\_DIRS \(fixes uclouvain\#2025\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([matthew-sharp](https://github.com/matthew-sharp))
- pi.c: avoid out of bounds access with POC \(fixes \#2025\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Encoder: grow again buffer size [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([zodf0055980](https://github.com/zodf0055980))
- opj\_j2k\_write\_sod\(\): avoid potential heap buffer overflow \(fixes \#2025\) \(probably master only\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- pi.c: avoid out of bounds access with POC \(refs https://github.com/uclouvain/openjpeg/issues/2025\#issuecomment-737122836\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- opj\_t2\_encode\_packet\(\): avoid out of bound access of \#2025, but likely not the proper fix [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- opj\_t2\_encode\_packet\(\): avoid out of bound access of \#2025, but likely not the proper fix [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- opj\_j2k\_setup\_encoder\(\): validate POC compno0 and compno1 \(fixes \#2025\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Encoder: avoid global buffer overflow on irreversible conversion when… [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Decoding: deal with some SPOT6 images that have tiles with a single tile-part with TPsot == 0 and TNsot == 0, and with missing EOC [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Free p\_tcd\_marker\_info to avoid memory leak [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([zodf0055980](https://github.com/zodf0055980))
- Encoder: grow again buffer size [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([zodf0055980](https://github.com/zodf0055980))
- Encoder: avoid uint32 overflow when allocating memory for codestream buffer \(fixes \#2025\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Java compatibility from 1.5 to 1.6 [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([jiapei100](https://github.com/jiapei100))
- opj\_decompress: fix double-free on input directory with mix of valid and invalid images [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- openjp2: Plug image leak when failing to allocate codestream index. [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([sebras](https://github.com/sebras))
- openjp2: Plug memory leak when setting data as TLS fails. [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([sebras](https://github.com/sebras))
- openjp2: Error out if failing to create Tier 1 handle. [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([sebras](https://github.com/sebras))
- Testing for invalid values of width, height, numcomps [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([szukw000](https://github.com/szukw000))
- Single-threaded performance improvements in forward DWT for 5-3 and 9-7 \(and other improvements\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Add support for multithreading in encoder [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Add support for generation of PLT markers in encoder [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Fix warnings about signed/unsigned casts in pi.c [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- opj\_decompress: add sanity checks to avoid segfault in case of decoding error [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- ignore wrong icc [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([szukw000](https://github.com/szukw000))
- Implement writing of IMF profiles [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- tests: add alternate checksums for libtiff 4.1 [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- opj\_tcd\_init\_tile\(\): avoid integer overflow [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- tests/fuzzers: link fuzz binaries using $LIB\_FUZZING\_ENGINE. [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([Dor1s](https://github.com/Dor1s))
- opj\_j2k\_update\_image\_dimensions\(\): reject images whose coordinates are beyond INT\_MAX \(fixes \#2025\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Fix resource leaks [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([dodys](https://github.com/dodys))
- abi-check.sh: fix false postive ABI error, and display output error log [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- pi.c: avoid integer overflow, resulting in later invalid access to memory in opj\_t2\_decode\_packets\(\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Add check to validate SGcod/SPcoc/SPcod parameter values. [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([sebras](https://github.com/sebras))
- Fix buffer overflow reading an image file less than four characters [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([robert-ancell](https://github.com/robert-ancell))
- compression: emit POC marker when only one single POC is requested \(f… [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Fix several potential vulnerabilities  [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([Young-X](https://github.com/Young-X))
- openjp2/j2k: Report error if all wanted components are not decoded. [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([sebras](https://github.com/sebras))
...
- v2.2.0 regression for decoding images where TNsot == 0 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Int overflow in jp3d [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Heap buffer overflow in opj\_j2k\_update\_image\_data\(\) triggered with Ghostscript [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- LINUX install doesn't work when building shared libraries is disabled [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- OPENJPEG null ptr dereference in openjpeg-2.3.0/src/bin/jp2/convert.c:2025 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- How to drop certain subbands/layers in DWT [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- where is the MQ-Coder ouput stream in t2.c? [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- OpenJPEG 2.3 \(and 2.2?\) multi component image fails to decode with KDU v7.10 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Missing checks for header\_info.height and header\_info.width in function pnmtoimage in src/bin/jpwl/convert.c, which can lead to heap buffer overflow [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Assertion Failure in jp2.c [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Division-by-zero vulnerabilities in the function pi\_next\_pcrl, pi\_next\_cprl and pi\_next\_rpcl in src/lib/openjp3d/pi.c [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Precinct switch \(-c\) doesn't right-shift last record to remaining resolution levels [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Sample: encode J2K a data using streams??? [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- HIGH THROUGHPUT JPEG 2025 \(HTJ2K\) [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- How to build openjpeg for arm linux? [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- crash [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- JP2000 returning OPJ\_CLRSPC\_UNKNOWN color space [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Compilation successful but install unsuccessful: Calling executables throws libraries missing error [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- fprintf format string requires 1 parameter but only 0 are given [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- fprintf format string requires 1 parameter but only 0 are given [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- sprintf buffer overflow [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- sprintf buffer overflow [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Infinite loop when reading jp2 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- missing format string parameter [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Excessive Iteration in opj\_t1\_encode\_cblks \(src/lib/openjp2/t1.c\) [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Out-of-bound left shift in opj\_j2k\_setup\_encoder \(src/lib/openjp2/j2k.c\) [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Encode image on Unsplash [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Integer overflow in opj\_t1\_encode\_cblks \(src/lib/openjp2/t1.c\) [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Signed Integer Overflow - 68065512 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Similar vulnerable functions related to CVE-2017-14041 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- \[ERROR\] COD marker already read. No more than one COD marker per tile.  [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- failing to install latest version of openjpeg from source [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Trouble compressing large raw image [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Download and installed code from 2.3 archive. Installing 2.2? [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- missing fclose [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- NULL Pointer Access in function imagetopnm of convert.c\(jp2\):2025 [\#860](https://github.com/uclouvain/openjpeg/issues/860)
- NULL Pointer Access in function imagetopnm of convert.c:2025\(jp2\)  [\#859](https://github.com/uclouvain/openjpeg/issues/859)
- Heap Buffer Overflow in function imagetotga of convert.c\(jp2\):942 [\#858](https://github.com/uclouvain/openjpeg/issues/858)

**Merged pull requests:**

- abi-check.sh: fix broken download URL [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- opj\_t1\_encode\_cblks: fix UBSAN signed integer overflow [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- convertbmp: detect invalid file dimensions early \(CVE-2025\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([hlef](https://github.com/hlef))
- color\_apply\_icc\_profile: avoid potential heap buffer overflow [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Fix multiple potential vulnerabilities and bugs [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([Young-X](https://github.com/Young-X))
- Fix several memory and resource leaks [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([nforro](https://github.com/nforro))
- Fix some potential overflow issues [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([stweil](https://github.com/stweil))
- jp3d/jpwl convert: fix write stack buffer overflow [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([hlef](https://github.com/hlef))
- Int overflow fixed [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([ichlubna](https://github.com/ichlubna))
- Update knownfailures- files given current configurations [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- CVE-2025: fix issues with zero bitmasks [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([hlef](https://github.com/hlef))
- openjp2/jp2: Fix two format strings [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([stweil](https://github.com/stweil))
- Changes in pnmtoimage if image data are missing [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([szukw000](https://github.com/szukw000))
- Relative path to header files is hardcoded in OpenJPEGConfig.cmake.in file [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([bukatlib](https://github.com/bukatlib))
- Cast on uint ceildiv [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([reverson](https://github.com/reverson))
- Add -DBUILD\_PKGCONFIG\_FILES to install instructions [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([robe2](https://github.com/robe2))
- Fix some typos in code comments and documentation [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([stweil](https://github.com/stweil))
- Fix regression in reading files with TNsot == 0 \(refs \#2025\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Use local type declaration for POSIX standard type only for MS compiler [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([stweil](https://github.com/stweil))
- Fix Mac builds [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- jp3d: Replace sprintf\(\) by snprintf\(\) in volumetobin\(\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([kbabioch](https://github.com/kbabioch))
- opj\_mj2\_extract: Rename output\_location to output\_prefix [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([kbabioch](https://github.com/kbabioch))
- mj2: Add missing variable to format string in fprintf\(\) invocation in meta\_out.c [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([kbabioch](https://github.com/kbabioch))
- Convert files to UTF-8 encoding [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([stweil](https://github.com/stweil))
- fix unchecked integer multiplication overflow [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([setharnold](https://github.com/setharnold))
- Fixed typos [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([radarhere](https://github.com/radarhere))
- Note that seek uses SEEK\_SET behavior. [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([ideasman42](https://github.com/ideasman42))
- Some Doxygen tags are removed [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([szukw000](https://github.com/szukw000))
- Fix resource leak \(CID 179466\) [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([stweil](https://github.com/stweil))
- Changed cmake version test to allow for cmake 2.8.11.x [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([radarhere](https://github.com/radarhere))
- Add missing fclose\(\) statement in error condition. [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([gfiumara](https://github.com/gfiumara))
...
- Sub-tile decoding: only apply IDWT on areas that participate to the window of interest [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Sub-tile decoding: memory use reduction and perf improvements [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
- Add capability to decode only a subset of all components of an image. [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([rouault](https://github.com/rouault))
...
- elf binary in source package ?  [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- opj\_cio\_open [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Building with Visual Studio 2025 [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- tcd.cpp\>:2025:33: error: assigning to 'OPJ\_INT32 \*' \(aka 'int \*'\) from incompatible type 'void \*' [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- j2k.cpp \> comparison of address of 'p\_j2k-\>m\_cp.tcps\[0\].m\_data' not equal to a null pointer is always true [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Openjpeg 2.2.0 always build shared library even though -DBUILD\_SHARED\_LIBS:bool=off [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- missing fclose [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Use opj\_image\_data\_free instead of opj\_free for image-\>comps\[\].data [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- malloc poison on some compilers - cross compiling [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Add OPJ\_VERSION\_MAJOR, OPJ\_VERSION\_MINOR, OPJ\_VERSION\_MICRO macros in openjpeg.h [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- Encode: do not perform rate control for single-tile lossless [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
- opj\_set\_decoded\_resolution\_factor\(\): bad interaction with opj\_set\_decode\_area\(\) and/or opj\_decode\(\) [\#2025](https://github.com/uclouvain/openjpeg/issues/2025)
...
- update instructions to build with Visual Studio and 64-Bit Visual C++ Toolset. [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([quangnh89](https://github.com/quangnh89))
- Add missing newline at end of file [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([stweil](https://github.com/stweil))
- merge master into coverity\_scan to update coverity results [\#2025](https://github.com/uclouvain/openjpeg/pull/2025) ([detonin](https://github.com/detonin))
...
- CVE-2025 FPE\(Floating Point Exception\) in lib/openjp2/pi.c:523 [\#855](https://github.com/uclouvain/openjpeg/issues/855)
- CVE-2025, CVE-2025, CVE-2025, CVE-2025 [\#854](https://github.com/uclouvain/openjpeg/issues/854)
...
- CVE-2025 and CVE-2025 [\#850](https://github.com/uclouvain/openjpeg/issues/850)
...
- read: segment too long \(2025\) with max \(35872\) for codeblock 0 \(p=19, b=2, r=5, c=1\) [\#284](https://github.com/uclouvain/openjpeg/issues/284)
...
- null ptr dereference in convert.c:2025 [\#843](https://github.com/uclouvain/openjpeg/issues/843)
...
- CVE-2025 Integer overflow in opj\_pi\_create\_decode [\#826](https://github.com/uclouvain/openjpeg/issues/826)
...
- CVE-2025: fix incrementing of "l\_tcp-\>m\_nb\_mcc\_records" in opj\_j2k\_read\_mcc [\#820](https://github.com/uclouvain/openjpeg/pull/820) ([mayeut](https://github.com/mayeut))
...
- bin/jp2/convert.c line 2025 Resource leak [\#607](https://github.com/uclouvain/openjpeg/issues/607)
...
- Decode times almost double\(!!\) on Visual Studio 2025, 2025 [\#505](https://github.com/uclouvain/openjpeg/issues/505)
...
- global-buffer-overflow src/lib/openjp2/t1.c:2025 opj\_t1\_getwmsedec [\#436](https://github.com/uclouvain/openjpeg/issues/436)
...
- Compilation error under Visual Studio 2025 [\#351](https://github.com/uclouvain/openjpeg/issues/351)
