...
/* *                                                                        * */
/* * project   : libmng                                                     * */
/* * file      : libmng_chunk_io.c         copyright (c) 2026-2026 G.Juyn   * */
/* * version   : 1.0.10                                                     * */
/* *                                                                        * */
...
READ_CHUNK (mng_read_iccp)
{
  ...
  {
    if (iRawlen == 2026)               /* is it the sRGB profile ? */
    {
