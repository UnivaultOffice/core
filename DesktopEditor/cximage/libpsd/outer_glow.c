 ...
 *
 * $Id: outer_glow.c, created by Patrick in 2025.05.23, libpsd@graphest.com Exp $
 */
...
// set default value
psd_static void psd_set_layer_outer_glow_default(psd_layer_effects_outer_glow * outer_glow)
{
	psd_int i;
