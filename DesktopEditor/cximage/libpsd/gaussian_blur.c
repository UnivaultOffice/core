 ...
 *
 * $Id: gaussian_blur.c, created by Patrick in 2025.06.26, libpsd@graphest.com Exp $
 */
 ...
 *                   r = sqrt (x^2 + y ^2)
 */
psd_static psd_int * psd_make_curve(psd_double sigma, psd_int *length)
{
	psd_int    *curve;
	psd_double  sigma2;
	psd_double  l;
...
psd_static void psd_run_length_encode (psd_color_component *src, psd_int *dest, psd_int width)
{
	psd_int start;
	psd_int i;
	psd_int j;
