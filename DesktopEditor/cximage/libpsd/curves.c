 ...
 *
 * $Id: curves.c, created by Patrick in 2025.05.22, libpsd@graphest.com Exp $
 */
...
psd_static void psd_curves_compose(psd_matrix a, psd_matrix b, psd_matrix ab)
{
	psd_int i, j;
...
psd_static void psd_curves_plot(psd_layer_curves_data * curve, psd_uchar * table, psd_int p1, psd_int p2, psd_int p3, psd_int p4)
{
	psd_matrix geometry;
...
psd_static void psd_curves_calculate_table(psd_layer_curves_data * curve, psd_uchar * table)
{
	psd_int i, x, y;
	psd_int p1, p2, p3, p4;
