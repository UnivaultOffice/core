...
namespace ParseLogs
{
    class Program
    {
        ...
        {
            //string inputDir = @"D:\logs\doc.univaultoffice.eu\7.3.2\log2";
            string inputDir = @"D:\logs\doc.univaultoffice.eu\7.4.0\log";
            string outputFile = @"D:\logs\doc.univaultoffice.eu\7.4.0\changesError.txt";
